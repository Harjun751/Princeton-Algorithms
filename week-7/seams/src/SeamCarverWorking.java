...
public class SeamCarverWorking {
    private int width;
    private int height;
    private int trueW;
    private int trueH;
    ...
    public SeamCarverWorking(Picture picture) {
        if (picture == null) {
...
//                distTo[v] = Double.POSITIVE_INFINITY;
    ...
    public static void main(String[] args) {
        SeamCarverWorking sc = new SeamCarverWorking(new Picture("/home/arjun/Documents/prinston-algos/week-7/seams/inputs/7x3.png"));
